...
<div class="roda-wrap">
    ...
    <div class="roda-container">
        ...
        <p class="roda-subtitle">
            Perbarui data motor di bawah ini untuk mengubah informasi armada RODA.
        </p>
        ...
        <div class="roda-card">
            ...
            <form
                action="{{ route('admin.motor.update', $motor->id) }}"
                method="POST"
            ...
            >
                ...
                <div class="roda-field">
                    ...
                    <select name="kategori_id" required>
                        ...
                        @foreach ($kategori as $item)
                            ...
                            <option
                                value="{{ $item->id }}"
                                {{ old('kategori_id', $motor->kategori_id) == $item->id ? 'selected' : '' }}
                            >
                                {{ $item->nama_kategori }}
                            </option>
                ...
                <div class="roda-field">
                    ...
                    <select name="status" required>
                        ...
                        <option
                            value="tersedia"
                            {{ old('status', $motor->status) == 'tersedia' ? 'selected' : '' }}
                        >
                            Tersedia
                        </option>
                        ...
                        <option
                            value="disewa"
                            {{ old('status', $motor->status) == 'disewa' ? 'selected' : '' }}
                        >
                            Disewa
                        </option>
                        ...
                        <option
                            value="perawatan"
                            {{ old('status', $motor->status) == 'perawatan' ? 'selected' : '' }}
                        >
                            Perawatan
                        </option>
